...
def pendencias():
    ...
    * Tentar usar o banco PostgreSQL
...
def chatgpt():
    """
    1. I have 4 Django models
    2. The model Investor relates to the Django standard User model (1:1)
    3. The model Stock does not relate to any
    4. The model Transaction relates with Stock (n:1) and with Investor (n:1)
    5. I created an user that works as an investor in my application
    6. Her name is "ana"
    7. I would like to gather her information, but the data are in Transaction model
    8. The data I want to gather is "stock_shares" and "share_unit_price", because I want to do some math with them
    9. How can I manage to retrieve the data from the model Transaction using the name of the user, that is "ana"?
    10. Or could it be done with the django tool "related_name" passed in the fields with relationship?

    1. Ok, but when I tried what you told me, Django returned me an error message
    2. The message: Cannot resolve keyword 'user' into field. Choices are: availability, created, id, investor, investor_id, profile, transactions, updated
    3. I will show you my "models.py" file
    ...
    4. By looking at my models and how they are related, can you tell if there is an efficient way to retreive data using reverse relationship to gather the information I asked you in the 10 items?
